...
- `tools/synthetic_sync/joint_fit_saved_endpoint.py` — replay an archived initialized joint fit without camera registration, retaining frozen pick weights, exact sources and separate internal/public endpoint objectives; checks hard-plane line geometry after finite segment publication.
