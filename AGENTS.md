...
| Sync input collection and Diagnose/Solve Sync result ownership | `scene/__init__.py` (`collect_sync_request` reads without preparation; Diagnose and Solve Sync check the captured request hash and scene identity before applying diagnostics or cameras) |
